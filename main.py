...
args = parser.add_argument('--beta', type=float, default=10,help='beta')
...
args = parser.add_argument('--d_lr', type=float, default=1e-4, help='learning_rate of discriminator')
args = parser.add_argument('--g_lr', type=float, default=2e-4, help='learning rate of generator')
