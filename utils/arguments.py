...
def parse_args():
    ...
    parser.add_argument('--model', type=str, default='gan', help='gan or fgan')
    ...
    parser.add_argument('--pretrain', type=int, default=3, help='number of pretrain epoch')
    ...
    parser.add_argument('--evaluation', type=str, default='auprc', help="auprc or auroc")
